...
st.write("Ajuste as variações percentuais para os critérios da UFPE e veja o impacto na sua posição, considerando o crescimento médio dos competidores.")
...
if st.sidebar.button("Simular Ranking"):
    with st.spinner("Executando simulação..."):
        ...
        st.metric(label="Posição Prevista da UFPE", value=f"{int(ufpe_predicted_position)}º lugar")
